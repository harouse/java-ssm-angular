    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <p>
                ...
                <ul>
                    <li>IoC 使得主 业务在相互调用过程中，不用再自己维护关系了，即不用再自己创建要使用的对象了。 而是 由 Spring 容器统一管理，自动“注入”</li>
                    <li>AOP 使得系统级服务得到了最大复用，且不用再 由程序员手工将系统级服务“混杂”到主业务逻辑中了，而是由 Spring 容器统一完成“织入”。</li>
                </ul>
            </p>
            ...
            <p>
                <ul>
                    <li>IOC 是一种思想，和 laravel中的用法一样，我们在控制器中需要什么，直接注入即可，这里都是IOC自动注入的 （假想这里有个例子）</li>
